...
import com.kotoshi.timeworldmod.client.renderer.PastZombieRenderState;
...
public class PastZombieModel<T extends Entity> extends EntityModel<PastZombieRenderState> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.tryParse(TimeWorldMod.MODID + ":past_zombie"), "main");
    ...
    public PastZombieModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(PastZombieRenderState state) {
